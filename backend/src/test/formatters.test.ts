import { formatINR, parseINR, formatDate, parseDate, getMonthKey, getMonthStartDate, getMonthEndDate, addMonths, monthsDifference } from '../../src/lib/format';
...
describe('Backend Formatters', () => {
  describe('formatINR', () => {
    ...
    test('should handle invalid inputs', () => {
      ...
      expect(formatINR(null as any)).toBe('0.00');
  ...
  describe('parseINR', () => {
    ...
    test('should handle edge cases', () => {
      ...
      expect(parseINR(null as any)).toBe(0);
      expect(parseINR(undefined as any)).toBe(0);
    });
  });
  ...
  describe('parseDate', () => {
    ...
    test('should handle invalid inputs', () => {
      ...
      expect(parseDate(null as any)).toBe(null);
      expect(parseDate(undefined as any)).toBe(null);
    });
  });
  ...
  describe('getMonthKey', () => {
    ...
    test('should handle invalid inputs', () => {
      ...
      expect(getMonthKey(null as any)).toBe('');
      expect(getMonthKey(undefined as any)).toBe('');
    });
  });
  ...
  describe('getMonthStartDate', () => {
    ...
    test('should handle invalid inputs', () => {
      ...
      expect(getMonthStartDate(null as any)).toBe(null);
    });
  });
  ...
  describe('getMonthEndDate', () => {
    ...
    test('should handle invalid inputs', () => {
      ...
      expect(getMonthEndDate(null as any)).toBe(null);
    });
  });
