/**
 * Formatting Utilities for ChitJar Backend
 * 
 ...
 * 
 * @param formattedAmount - The formatted INR string
 ...
 * 
 * @param date - The date to extract month key from
 * @returns Month key in YYYY-MM format
 */
export function getMonthKey(date: Date | string | number): string {
  let d: Date;
